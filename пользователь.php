...
if(isset($_POST['button1'])){
	...
	//если новый
	if(empty($userlogin)){
		echo "<div id='ram'><h3>Данный логин новый!<br>Нажмите на кнопку 'Войти', перейдя по <a style='text-decoration: underline;color:#ffbb29;' href='польз.html'>ссылке</a></h3></div>";
	}
	else
	{
		echo "<div id='ram'><h3>Вы авторизовались!<br>Чтобы перейти в свой личный кабинет перейдите по <a style='text-decoration: underline;color:#ffbb29;' href='профиль.php'>ссылке</h3></div>";
	}
