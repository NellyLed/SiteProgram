										...
										<div class='span12' style='background-color:rgba(0, 0, 0, .8);'>
											<div class='row-fluid'>
												<div class='span4 offset4'>
													<br>
													<h1 class='threed text-center' style='letter-spacing:4px'>FRONTEND-РАЗРАБОТЧИК</h1>
												</div>
											</div>
											<div class='row-fluid'>
												<div class='span4 offset4'>
											...
											<div class='row-fluid'>
												<div class='span6 text-right'>
													...
													<div class='row-fluid'>
														<h4 style='font-size:15px;text-align:justify;padding:20px;'>Вы научитесь создавать интерфейсы веб-сервисов с помощью языков программирования и дополнительных технологий. Сможете разрабатывать планировщики задач, мессенджеры, интернет-магазины.</h4>
													</div>
													<br>
													<div class='row-fluid'>
						...
						<section class="white-text grey p-5 rounded">
							...
							<div class="row">
								<div class="col-md-4 mb-4">
									<div class="row">
										<div class="col-6 pr-0">
											<h4 class="display-4 text-right mb-0 count-up" data-from="0" data-to="66" data-time="2000">66</h4>
										</div>
									    <div class="col-6">
							    ...
							    <div class="col-md-4 mb-4">
									<div class="row">
										<div class="col-6 pr-0">
											<h4 class="display-4 text-right mb-0 count1" data-from="0" data-to="5000" data-time="2000">5,000</h4>
										</div>
										<div class="col-6">
...
Почта Банк;">Банки</button>
						...
						<div class='mb-2 text-muted'>Длительность:3 месяца<span class='fa-regular fa-question-circle'></span></div>
						<ul class='list-group'>
						<!--1 часть-->
							<li class='list-group-item'>
								<div class='row my-2'>
									...
									<div class='col'>
										<h3 class='h5'>Бесплатная вводная часть</h3>
										<div class='mt-3 text-muted'>2 часа</div>
									</div>
							...
							<li class='list-group-item'>
								<div class='row my-2'>
									...
									<div class='col'>
										<h3 class='h5'>Проект «Веб-мессенджер»</h3>
							...
							<li class='list-group-item'>
								<div class='row my-2'>
									...
									<div class='col'>
										<h3 class='h5'>Командный проект</h3>
								...
								<li class='list-group-item'>
									<div class='row my-2'>
										...
										<div class='col'>
											<h3 class='h5'>Алгоритмы и структуры данных. Включённый курс</h3>
											<div class='mt-3 text-muted'>2 недели</div>
										</div>
										<div class='w-100 d-lg-none'></div>
										<div class='col-1 d-lg-none'></div>
				...
				<div style="text-align:center;margin-bottom:2%;margin-top:2%;"><a class="back" href='каталог_курсов.php'>В каталог</a><a class="back" href='front.php'>Начать</a></div>
			</div>	
			<script>
				(function ($){
				  $.fn.counter = function() {
