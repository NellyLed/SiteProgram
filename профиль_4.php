...
<link rel='stylesheet' href='проф_2.css'>
  ...
  <title>Календарь развития</title>
  ...
  <div class="profile-nav col-md-3">
      <div class="panel">
          ...
          <ul class="nav nav-pills nav-stacked">
			  ...
			  <li class="active"><a href="#"><i class="fa fa-calendar"></i>Каледарь развития</a></li>
...
<header>
  <div class="wrapper" >
    ...
    <div class="c-month">
        <span id="prev" class="prev fa fa-angle-left" aria-hidden="true" style='background-color:#ffdab9'></span>
        <div id="c-paginator">
          <span class="c-paginator__month">Январь</span>
          <span class="c-paginator__month">Февраль</span>
          <span class="c-paginator__month">Март</span>
          <span class="c-paginator__month">Апрель</span>
          <span class="c-paginator__month">Май</span>
          <span class="c-paginator__month">Июнь</span>
          <span class="c-paginator__month">Июль</span>
          <span class="c-paginator__month">Август</span>
          <span class="c-paginator__month">Сентябрь</span>
          <span class="c-paginator__month">Октябрь</span>
          <span class="c-paginator__month">Ноябрь</span>
          <span class="c-paginator__month">Декабрь</span>
        </div>
        <span id="next" class="next fa fa-angle-right" aria-hidden="true" style='background-color:#ffdab9'></span>
      </div>
      <span class="c-paginator__year">2023</span>
    </div>
    <div class="c-sort">
      <a class="o-btn c-today__btn" href="javascript:;" style='background-color:#ffdab9' >Сегодня</a>
    </div>
  </div>
</header>
<div class="wrapper" style='width:97%;'>
  <div class="c-calendar">
    <div class="c-calendar__style c-aside">
      <a class="c-add o-btn js-event__add" href="javascript:;" style='background-color:#ffdab9'>Добавить событие<span class="fa fa-plus"></span></a>
    ...
    <div class="c-cal__container c-calendar__style">
      ...
      fill_table("Январь", 31, "01");
      fill_table("Февраль", 28, "02");
      fill_table("Март", 31, "03");
      fill_table("Апрель", 30, "04");
      fill_table("Май", 31, "05");
      fill_table("Июнь", 30, "06");
      fill_table("Июль", 31, "07");
      fill_table("Август", 31, "08");
      fill_table("Сентябрь", 30, "09");
      fill_table("Октябрь", 31, "10");
      fill_table("Ноябрь", 30, "11");
      fill_table("Декабрь", 31, "12");
      </script>
    </div>
  </div>

  <div class="c-event__creator c-calendar__style js-event__creator">
    <a href="javascript:;" class="o-btn js-event__close">Закрыть <span class="fa fa-close"></span></a>
    <form id="addEvent">
      <input placeholder="Имя" type="text" name="name">
      <input type="date" name="date">
      <textarea placeholder="Сообщение" name="notes" cols="30" rows="10"></textarea>
      <select name="tags">
          <option value="event">Событие</option>
          <option value="important">Важно</option>
          <option value="birthday">День рождения</option>
          <option value="festivity">Фествиль</option>
        </select>
    </form>
    <br>
    <a href="javascript:;" class="o-btn js-event__save">Сохранить <span class="fa fa-save"></span></a>
  <br></div>
...
defaultEvents(today, 'Да!', 'Сегодня ваш день', 'важно');
defaultEvents('2023-01-01', 'Новый год', 'Много подарков!!!!', 'фестивиль');
defaultEvents('2023-04-04', "День рождения компании", 'Много подарков!!!!', 'день рождения');
defaultEvents('2023-08-03', "День выхода нового курса", 'Дешево!!!!', 'день');
...
function moveNext(fakeClick, indexNext) {
  for (var i = 0; i < fakeClick; i++) {if (window.CP.shouldStopExecution(0)) break;
    $(".c-main").css({
      left: "-=100%" });
...
function movePrev(fakeClick, indexPrev) {
  for (var i = 0; i < fakeClick; i++) {if (window.CP.shouldStopExecution(1)) break;
    $(".c-main").css({
      left: "+=100%" });
