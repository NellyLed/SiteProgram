										...
										<div class='span12' style='background-color:rgba(0, 0, 0, .8);'>
											<div class='row-fluid'>
												<div class='span4 offset4'>
													<br>
													<h1 class='threed text-center' style='letter-spacing:4px'>C++ РАЗРАБОТЧИК</h1>
												</div>
											</div>
											<div class='row-fluid'>
												<div class='span4 offset4'>
											...
											<div class='row-fluid'>
												<div class='span6 text-right'>
													...
													<div class='row-fluid'>
														<h4 style='font-size:15px;text-align:justify;padding:20px;'>Будете создавать сложные программы и сервисы, разрабатывать высоконагруженные сетевые приложения, игры, графические движки, компоненты для операционных систем и железа. На этом языке написаны Windows, Linux и macOS, Android, Chrome, Counter-Strike, StarCraft и Diablo..</h4>
													</div>
													<br>
													<div class='row-fluid'>
						...
						<section class="white-text grey p-5 rounded">
							...
							<div class="row">
								<div class="col-md-4 mb-4">
									<div class="row">
										<div class="col-6 pr-0">
											<h4 class="display-4 text-right mb-0 count-up" data-from="0" data-to="55" data-time="2000">55</h4>
										</div>
									    <div class="col-6">
							    ...
							    <div class="col-md-4 mb-4">
									<div class="row">
										<div class="col-6 pr-0">
											<h4 class="display-4 text-right mb-0 count1" data-from="0" data-to="4500" data-time="2000">4,500</h4>
										</div>
										<div class="col-6">
...
Почта Банк;">Банки</button>
						...
						<div class='mb-2 text-muted'>Длительность:4 месяца<span class='fa-regular fa-question-circle'></span></div>
						<ul class='list-group'>
						<!--1 часть-->
							<li class='list-group-item'>
								<div class='row my-2'>
									...
									<div class='col'>
										<h3 class='h5'>Базовые понятия программирования </h3>
										<div class='mt-3 text-muted'>10 часов</div>
									</div>
							...
							<li class='list-group-item'>
								<div class='row my-2'>
									...
									<div class='col'>
										<h3 class='h5'>Основные компоненты C++</h3>
								...
								<li class='list-group-item'>
									<div class='row my-2'>
										...
										<div class='col'>
											<h3 class='h5'>Эффективность кода</h3>
								...
								<li class='list-group-item'>
									<div class='row my-2'>
										...
										<div class='col'>
											<h3 class='h5'>Элегантность и масштабируемость</h3>
											<div class='mt-3 text-muted'>2 недели</div>
										</div>
										<div class='w-100 d-lg-none'></div>
										<div class='col-1 d-lg-none'></div>
								...
								<li class='list-group-item'>
									<div class='row my-2'>
										...
										<div class='col'>
											<h3 class='h5'>Разработка библиотек и больших проектов</h3>
								...
								<li class='list-group-item'>
									<div class='row my-2'>
										...
										<div class='col'>
											<h3 class='h5'>Дипломный проект</a></h3>
											<div class='mt-3 text-muted'>2 недели</div>
										</div>
										<div class='w-100 d-lg-none'></div>
										<div class='col-1 d-lg-none'></div>
								...
								<li class='list-group-item'>
									<div class='row my-2'>
										...
										<div class='col'>
											<h3 class='h5'>Специализация C++ бэкенд</h3>
											<div class='mt-3 text-muted'>2 недели</div>
										</div>
										<div class='w-100 d-lg-none'></div>
										<div class='col-1 d-lg-none'></div>
				...
				<div style="text-align:center;margin-bottom:2%;margin-top:2%;"><a class="back" href='каталог_курсов.php'>В каталог</a><a class="back" href='c++_p.php'>Начать</a></div>
			</div>	
			<script>
				(function ($){
				  $.fn.counter = function() {
