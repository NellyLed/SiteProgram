...
<html data-bs-theme='light' lang='ru' prefix='og: https://ogp.me/ns#'>
										...
										<div class='span12' style='background-color:rgba(0, 0, 0, .8);'>
											<div class='row-fluid'>
												<div class='span4 offset4'>
													<br>
													<h1 class='threed text-center' style='letter-spacing:4px'>PYTHON-РАЗРАБОТЧИК</h1>
												</div>
											</div>
											<div class='row-fluid'>
												<div class='span4 offset4'>
											...
											<div class='row-fluid'>
												<div class='span6 text-right'>
													...
													<div class='row-fluid'>
														<h4 style='font-size:15px;text-align:justify;padding:20px;'>На Python пишут веб-приложения и нейросети, проводят научные вычисления и автоматизируют процессы. Язык просто выучить, даже если вы никогда не программировали.</h4>
													</div>
													<br>
													<div class='row-fluid'>
												...
												<div class='span6 text-left'>
													<div class='span5 text-center'>
														<img src='python_icon.png' id='big-cloud' style='text-shadow: 1px 1px white, -1px -1px #666;'>
													</div>
													<div class='span6 text-left'>
						...
						<section class="white-text grey p-5 rounded">
							...
							<div class="row">
								<div class="col-md-4 mb-4">
									<div class="row">
										<div class="col-6 pr-0">
											<h4 class="display-4 text-right mb-0 count-up" data-from="0" data-to="50" data-time="2000">50</h4>
										</div>
									    <div class="col-6">
							    ...
							    <div class="col-md-4 mb-4">
									<div class="row">
										<div class="col-6 pr-0">
											<h4 class="display-4 text-right mb-0 count1" data-from="0" data-to="999" data-time="2000">999</h4>
										</div>
										<div class="col-6">
	...
	Помощь 24/7
					...
					<h3 class="text-center font-weight-bold mb-4 pb-2" style='margin-top:3%;margin-bottom:2%'>Почему стоит обратить внимание на курс?</h3>
...
Почта Банк;">Банки</button>
						...
						<div class='mb-2 text-muted'>Длительность:9 месяцев<span class='fa-regular fa-question-circle'></span></div>
						<ul class='list-group'>
						<!--1 часть-->
							...
							<li class='list-group-item'>
								<div class='row my-2'>
									...
									<div class='col'>
										<h3 class='h5'>Углубленный Python</h3>
							...
							<li class='list-group-item'>
								<div class='row my-2'>
									...
									<div class='col'>
										<h3 class='h5'>Бэкенд на Django</h3>
										<div class='mt-3 text-muted'>10 недель</div>
									</div>
									<div class='w-100 d-lg-none'></div>
									<div class='col-1 d-lg-none'></div>
									<div class='col col-lg-auto d-flex flex-lg-column flex-wrap flex-lg-nowrap align-items-lg-end justify-content-lg-center mt-2 mt-lg-0'>
								...
								<li class='list-group-item'>
									<div class='row my-2'>
										...
										<div class='col'>
											<h3 class='h5'>API: интерфейс взаимодействия программ</h3>
											<div class='mt-3 text-muted'>9 недель</div>
										</div>
										<div class='w-100 d-lg-none'></div>
										<div class='col-1 d-lg-none'></div>
										<div class='col col-lg-auto d-flex flex-lg-column flex-wrap flex-lg-nowrap align-items-lg-end justify-content-lg-center mt-2 mt-lg-0'>
								...
								<li class='list-group-item'>
									<div class='row my-2'>
										...
										<div class='col'>
											<h3 class='h5'>Алгоритмы и структуры данных</h3>
								...
								<li class='list-group-item'>
									<div class='row my-2'>
										...
										<div class='col'>
											<h3 class='h5'>Управление проектом на удалённом сервере</h3>
								...
								<li class='list-group-item'>
									<div class='row my-2'>
										...
										<div class='col'>
											<h3 class='h5'>Дипломный проект «Продуктовый помощник»</a></h3>
											<div class='mt-3 text-muted'>3 неделя</div>
										</div>
										<div class='w-100 d-lg-none'></div>
										<div class='col-1 d-lg-none'></div>
										<div class='col col-lg-auto d-flex flex-lg-column flex-wrap flex-lg-nowrap align-items-lg-end justify-content-lg-center mt-2 mt-lg-0'>
								...
								<li class='list-group-item'>
									<div class='row my-2'>
										...
										<div class='col'>
											<h3 class='h5'>Tрудоустройство</h3>
											<div class='mt-3 text-muted'>6 недель</div>
										</div>
										<div class='w-100 d-lg-none'></div>
										<div class='col-1 d-lg-none'></div>
								...
								<li class='list-group-item'>
									<div class='row my-2'>
										<div class='col-1 text-center'>
											<div class='h3 fw-light'>9</div>
										</div>
										<div class='col'>
											<h3 class='h5'>Акселерация</h3>
											<div class='mt-3 text-muted'>от 8 до 24 недель</div>
										</div>
										<div class='w-100 d-lg-none'></div>
										<div class='col-1 d-lg-none'></div>
										<div class='col col-lg-auto d-flex flex-lg-column flex-wrap flex-lg-nowrap align-items-lg-end justify-content-lg-center mt-2 mt-lg-0'>
			...
			<a class="back" href='python.php'>Начать</a></div>
