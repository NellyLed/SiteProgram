...
<!--1 глава-->
<details>
    <summary><b><a href='c++_plan.php' style='color:#000;'>1)Базовые понятия программирования</a></b></summary>
    <p>
		1 Набор инструментов для программирования с нуля<br>
		2 Переменные<br>
		3 Объекты<br>
		4 Массивы<br>
		5 Функции<br>
		6 Логические ветви и сравнения<br>
		7 Циклы<br>
		8 null и undefined<br>
		9 Области применения<br>
		10 Комментирование кода<br>
	</p>
</details>

<!--2 глава-->
<details>
    <summary><a data-toggle="modal" data-target="#exampleModal" >2)Основы C++</a></summary>
    <p>
		1 Базовые конструкции C++<br>
		2 Стандартная библиотека C++<br>
		3 Идиомы C++<br>
...
<!--3 глава-->
<details>
    <summary><a data-toggle="modal" data-target="#exampleModal" >3)Основные компоненты C++</a></summary>
    <p> 1 Алфавит языка<br>
		2 Идентификаторы<br>
		3 Ключевые слова<br>
		4 Знаки операций<br>
		5 Константы<br>
...
<!--4 глава-->
<details>
    <summary><a data-toggle="modal" data-target="#exampleModal" >4)Эффективность кода</a></summary>
	<p>1 Эффективность кода<br>
	</p>
</details>
<!--5 глава-->
<details>
    <summary><a data-toggle="modal" data-target="#exampleModal" >5)Элегантность и масштабируемость</a></summary>
	<p>1 Элегантность<br>
	2 Масштабируемость<br>
	</p>
</details>
<!--6 глава-->
<details>
    <summary><a data-toggle="modal" data-target="#exampleModal" >6)Разработка библиотек и больших проектов</a></summary>
	<p>1 Папка в проекте<br>
	2 Отдельный пакет<br>
	3 Решение на отдел<br>
	4 Решение на компанию<br>
	</p>
</details>
<!--7 глава-->
<details>
    <summary><a data-toggle="modal" data-target="#exampleModal" >7)Дипломный проект</a></summary>
	<p>По согласованию с преподавателем</p>
</details>
<!--8 глава-->
<details>
    <summary><a data-toggle="modal" data-target="#exampleModal" >8)Специализация C++ бэкенд</a></summary>
	<p>1 Рабочее окружение бэкенд-разработчика<br>
	2 Логирование и мониторинг<br>
	3 Нагрузочное тестирование и продвинутая отладка<br>
	4 SQL и базы данных<br>
	</p>
