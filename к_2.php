...
<div class="main">
  ...
  <div class='row-fluid'>
    <div class='span12' style='background-color:rgba(0, 0, 0, .8);'>
      ...
      <div class='row-fluid'>
        <div class='span4 offset4'>
          <h1 class='threed text-center' style='letter-spacing:10px;margin-top:-30px;'>
            ___________
          </h1>
        </div>
      </div>
      <div class='row-fluid'>
        <div class='span6 text-right'>
          ...
          <div class='row-fluid'>
            <h4 style='font-size:15px;text-align:justify;padding:20px;'>
        ...
        <div class='span6 text-left'>
          <div class='span5 text-center'>
            <img src='javv.png' id='big-cloud' style='text-shadow: 1px 1px white, -1px -1px #666;'>
          </div>
          <div class='span6 text-left'>
  ...
  <br>
    ...
    <div class='span12' style='background-color:rgba(0, 0, 0, .8);'>
      <div class='span4'>
        <div class='row-fluid'>
          <h3 class='threed text-left' style='margin-left:20px;'>
            Наша
          </h3>
        </div>
        <div class='row-fluid'>
          <h3 class='threed text-center' style='margin-left:20px;'>
            команда &nbsp
          </h3>
        </div>
        <div class='row-fluid'>
          <h3 class='threed text-right' style='margin-left:20px;'>
            это ...
          </h3>
        </div>
        <br>
        ...
        <div class="solution_cards_box" style='margin-top:15%;'>
          <div class="solution_card" >
            ...
            <div class="solu_description">
              <p>
                Пройдите специальный психологический тест для понимания к какой сфере IT-деятельности у вас потенциал.
              </p>
...
4 индивидуальные сессии по 25 минут;">Школы</button>
        ...
        <div class="solution_cards_box sol_card_top_3">
          <div class="solution_card">
            ...
            <div class="solu_title">
              <h3>Легкое обучение</h3>
            </div>
            <div class="solu_description">
              <p>
               Расходы за первые 3 месяца обучения вы сможете оплатить позже без переплаты по процентам и первоначального взноса.
              </p>
...
Почта Банк;">Банки</button>
          ...
          <div class="solution_card">
            ...
            <div class="solu_title">
              <h3>Поддержка от гос-ва</h3>
            </div>
            <div class="solu_description">
              <p>
                1)Доступна льготная ипотека по ставке 5%.<br>2)Отсрочка от армии мужчин от 18 до 27 лет.
              </p>
...
<ul class="timeline">
	...
	<li>
		...
		<div class="timeline-description">После теории вас ждет практическая работа или тест.Все задачи приближены к реальным, их можно положить в портфолио.</div>
		</div>
	</li>
...
<ul class='list-group'>
	...
	<li class='list-group-item'>
		<div class='row my-2'>
			...
			<div class='col'>
				<h3 class='h5'>Java Core введение</h3>
	...
	<li class='list-group-item'>
		<div class='row my-2'>
			...
			<div class='col'>
				<h3 class='h5'>Java Core продолжение</h3>
				<div class='mt-3 text-muted'>8 недель</div>
			</div>
			<div class='w-100 d-lg-none'></div>
			<div class='col-1 d-lg-none'></div>
	...
	<li class='list-group-item'>
		<div class='row my-2'>
			...
			<div class='col'>
				<h3 class='h5'>Spring Boot и работа с базами данных</h3>
				<div class='mt-3 text-muted'>8 недель</div>
			</div>
			<div class='w-100 d-lg-none'></div>
			<div class='col-1 d-lg-none'></div>
	...
	<li class='list-group-item'>
		<div class='row my-2'>
			...
			<div class='col'>
				<h3 class='h5'>Spring, ORM и работа на сервере</h3>
	...
	<li class='list-group-item'>
		<div class='row my-2'>
			...
			<div class='col'>
				<h3 class='h5'>Подготовка к собеседованию и дипломный проект</h3>
...
<ul class="circles">
				...
				<a class="back" href='java_введ.php'>Начать</a></div>			
		</div>
