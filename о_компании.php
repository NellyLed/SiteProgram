...
<html>
  ...
  <script src="https://maxcdn.bootstrapcdn.com/bootstrap/3.4.1/js/bootstrap.min.js"></script>
		<link rel='stylesheet' href='о_ком.css'>
		<script src="//netdna.bootstrapcdn.com/bootstrap/4.3.0/js/bootstrap.min.js"></script>
		<script src="//code.jquery.com/jquery-1.11.1.min.js"></script>

  	</head>
	<body>
	<h1>Поговорим о компании</h1>
	<!--1 блок-->
<div id="about" class="container-fluid">
  <div class="row">
    <div class="col-sm-8">
      <h2>О нас</h2><br>
      <h4> Мы образовательная платформа.Здесь вы сможете освоить новую профессию, получить базовые знания и практические навыки, которые помогут вам с будущим трудоустройством.</h4><br>
      <p><i>Мы:</i><br>- учим как веб-разработке, так и машинному обучению, программированию на высокоуровневых языках программирования.<br>- Рассказываем о личном опыте в профессии и решаем сложные задачи. Будет полезно студентам и новичкам.<br>- Вы сможете быстро принять решение, какая область в IT вам наиболее интересна. Учится можно с любых устройств.<br>- У нас проходят практику как эксперты,так и новички.Больше 100 работодателей сотрудничают с нами.</p>
    </div>
    <div class="col-sm-4">
...
<div class="container-fluid bg-grey">
  <div class="row">
    ...
    <div class="col-sm-8">
      <h2>Компаниям нужны специалисты с ИТ-навыками</h2><br>
	    <h4><strong>ИТ-специалист</strong> - это представитель одной из самых востребованных профессий, связанных с разработкой программ и использованием рахличных устройств.Эта проыессия с годами становится все более высокооплачиваемой, из-за этого многие компании конкурируют на внутреннем и внешнем рынке.</h4><br>
		<p><strong>Перспективно:</strong>Каждый год число ИТ-вакансий растет больше чем на 10% каждый год. За месяц 60 тыс. новых вакансий</p><br>
		<p><strong>Востребованно:</strong> Зарплата начинающего специалиста — от 60 000 ₽. А после — от 100 000 ₽</p><br>
...
<div class="row">
    <div class="col-sm-4">
	<div class="outset "><h5>>12</h5><h6>Интересных и запоминающихся курсов</h6></div>
    </div>
    <div class="col-sm-4">
      <div class="outset "><h5>>45</h5><h6>Талантливых и опытных кураторов</h6></div>
    </div>
    <div class="col-sm-4">
      <div class="outset "><h5>>120000</h5><h6>Увлеченных и постоянных пользователей</h6></div>
    </div>
  </div>
  </div>
<!--4 блок-->
<h3>География наших пользователей</h3>
  <div class="rf-map">
	...
	<div class="container-stall">
  <div class="row">
  <p class='ui'>Процент пользователей:</p>
		 <div class="col">
      <div class='square-block'></div><p class='uit'>-0-10%</p>
		</div>
		<div class='col'>
		<div class='square1-block'></div><p class='uit'>-10-25%</p>
		</div>
		<div class='col'>
		<div class='square2-block'></div><p class='uit'>-25-40%</p>
		</div>
		<div class='col'>
		<div class='square3-block'></div><p class='uit'>-40-60%</p>
		</div>
		<div class='col'>
		<div class='square4-block'></div><p class='uit'>-60-85%</p>
		</div>
		<div class='col'>
		<div class='square5-block'></div><p class='uit'>-85-100%</p>
		</div>
   </div>
  </div>
</div>
...
<div class="container mt-5">
                    <p class='oo'>Вам доступно</p>
                <div class="pi"><label><input type="checkbox" class="option-input radio"> - Круглосуточный доступ к личному кабинету</label></div>
                <div class="pi"><label><input type="checkbox" class="option-input radio"> - Регулярное обновление курсов</label></div>
                <div class="pi"><label><input type="checkbox" class="option-input radio"> - Проверочные тесты и практические задания</label></div>
                <div class="pi"><label><input type="checkbox" class="option-input radio"> - Кураторы — признанные профессионалы</label></div>
                <div class="pi" ><label><input type="checkbox" class="option-input radio"> - Проекты от реальных заказчиков</label></div>
                <br><h6 class="line-text"><span>Поделиться с:</span></h6>
            <div style='text-align:center'>
			<img class="rounded-circle" src="https://i.imgur.com/rQMmlf6.jpg" width="40">
			<img class="rounded-circle" src="https://i.imgur.com/zE0TPlF.jpg" width="40">
			<img class="rounded-circle" src="https://i.imgur.com/rCAhOXi.jpg" width="40">
			<img class="rounded-circle" src="https://i.imgur.com/28GMrS0.jpg" width="40">
			</div>
  

</div>
<!--6 блок-->
<h3>Как устроены наши лекции</h3>
		<div id='car'>
			<div id="carousel" class="carousel slide" data-ride="carousel">
			  ...
			  <div class="carousel-inner">
				<div class="item active">
				  <img src="photo_1.jpg" alt="..." width="50%">
				   <div class="carousel-caption">
				   <p style='color:white;'>Интересные вебинары</p>
				  </div>
				</div>
				<div class="item">
				  <img src="photo_2.jpg" alt="..." width="50%">
				 <div class="carousel-caption">
				   <p style='color:white;'>Актуальные знания</p>
				  </div>
				</div>
				<div class="item">
				  <img src="photo_3.jpg" alt="..." width="50%">
				<div class="carousel-caption">
					<p style='color:white;'>Возможность найти собеседников</p>
				  </div>
				</div>
			  </div>
			  <!-- Элементы управления -->
...
<!--7 блок-->
<h3>Основатели нашей платформы</h3>
              <div class="image">
			<span><img class="rounded" src="profile_2.png" style='display:block;'><p><b>Круглов</b><br>Александр Викторович</p></span>
			<span><img class="rounded" src="profile_2.png" style='display:block;'><p><b>Кочетов</b><br>Александр Степанович</p></span>
			<span><img class="rounded" src="profile_2.png" style='display:block;'><p><b>Ветров</b><br>Степан Вячеславович</p></span>
			<span><img class="rounded" src="profile_2.png" style='display:block;'><p><b>Комослов</b><br>Андрей Владимирович</p></span>
			</div>
