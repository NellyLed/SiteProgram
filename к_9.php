										...
										<div class='span12' style='background-color:rgba(0, 0, 0, .8);'>
											<div class='row-fluid'>
												<div class='span4 offset4'>
													<br>
													<h1 class='threed text-center' style='letter-spacing:4px'>АНАЛИТИК 1С</h1>
												</div>
											</div>
											<div class='row-fluid'>
												<div class='span4 offset4'>
											...
											<div class='row-fluid'>
												<div class='span6 text-right'>
													...
													<div class='row-fluid'>
														<h4 style='font-size:15px;text-align:justify;padding:20px;'>Будете улучшать рабочие процессы в компаниях — автоматизировать учёт и управление. Станете востребованным специалистом по внедрению и сопровождению решений на базе 1С.</h4>
													</div>
													<br>
													<div class='row-fluid'>
						...
						<section class="white-text grey p-5 rounded">
							...
							<div class="row">
								<div class="col-md-4 mb-4">
									<div class="row">
										<div class="col-6 pr-0">
											<h4 class="display-4 text-right mb-0 count-up" data-from="0" data-to="34" data-time="2000">34</h4>
										</div>
									    <div class="col-6">
							    ...
							    <div class="col-md-4 mb-4">
									<div class="row">
										<div class="col-6 pr-0">
											<h4 class="display-4 text-right mb-0 count1" data-from="0" data-to="2600" data-time="2000">2,600</h4>
										</div>
										<div class="col-6">
...
Почта Банк;">Банки</button>
						...
						<div class='mb-2 text-muted'>Длительность:2 месяца<span class='fa-regular fa-question-circle'></span></div>
						<ul class='list-group'>
						<!--1 часть-->
							<li class='list-group-item'>
								<div class='row my-2'>
									...
									<div class='col'>
										<h3 class='h5'>Основы профессии аналитика 1С</h3>
										<div class='mt-3 text-muted'>120 часов</div>
									</div>
							...
							<li class='list-group-item'>
								<div class='row my-2'>
									...
									<div class='col'>
										<h3 class='h5'>Внедрение и эксплуатация 1С на практике: методики и шаблоны</h3>
							...
							<li class='list-group-item'>
								<div class='row my-2'>
									...
									<div class='col'>
										<h3 class='h5'>Проектирование и управление разработкой информационных систем 1С</h3>
								...
								<li class='list-group-item'>
									<div class='row my-2'>
										...
										<div class='col'>
											<h3 class='h5'>Итоговый проект</h3>
											<div class='mt-3 text-muted'>2 недели</div>
										</div>
										<div class='w-100 d-lg-none'></div>
										<div class='col-1 d-lg-none'></div>
				...
				<div style="text-align:center;margin-bottom:2%;margin-top:2%;"><a class="back" href='каталог_курсов.php'>В каталог</a><a class="back" href='1с_plan.php'>Начать</a></div>
			</div>	
			<script>
				(function ($){
				  $.fn.counter = function() {
