										...
										<div class='span12' style='background-color:rgba(0, 0, 0, .8);'>
											<div class='row-fluid'>
												<div class='span4 offset4'>
													<br>
													<h1 class='threed text-center' style='letter-spacing:4px'>DevOps-ИНЖЕНЕР</h1>
												</div>
											</div>
											<div class='row-fluid'>
												<div class='span4 offset4'>
											...
											<div class='row-fluid'>
												<div class='span6 text-right'>
													...
													<div class='row-fluid'>
														<h4 style='font-size:15px;text-align:justify;padding:20px;'>Вы научитесь администрировать Linux, настраивать веб-серверы и будете автоматизировать разработку сложных IT-продуктов.</h4>
													</div>
													<br>
													<div class='row-fluid'>
						...
						<section class="white-text grey p-5 rounded">
							...
							<div class="row">
								<div class="col-md-4 mb-4">
									<div class="row">
										<div class="col-6 pr-0">
											<h4 class="display-4 text-right mb-0 count-up" data-from="0" data-to="45" data-time="2000">45</h4>
										</div>
									    <div class="col-6">
							    ...
							    <div class="col-md-4 mb-4">
									<div class="row">
										<div class="col-6 pr-0">
											<h4 class="display-4 text-right mb-0 count1" data-from="0" data-to="4000" data-time="2000">4,000</h4>
										</div>
										<div class="col-6">
...
Почта Банк;">Банки</button>
						...
						<div class='mb-2 text-muted'>Длительность:5 месяцев<span class='fa-regular fa-question-circle'></span></div>
						<ul class='list-group'>
						<!--1 часть-->
							<li class='list-group-item'>
								<div class='row my-2'>
									...
									<div class='col'>
										<h3 class='h5'>Системы контроля версий и автоматизация сборки приложений </h3>
										<div class='mt-3 text-muted'>15 часов</div>
									</div>
							...
							<li class='list-group-item'>
								<div class='row my-2'>
									...
									<div class='col'>
										<h3 class='h5'>Гибкие методологии и Continuous Integration </h3>
							...
							<li class='list-group-item'>
								<div class='row my-2'>
									...
									<div class='col'>
										<h3 class='h5'>Сети и основы работы на серверах Linux </h3>
										<div class='mt-3 text-muted'>2 недели</div>
									</div>
									<div class='w-100 d-lg-none'></div>
									<div class='col-1 d-lg-none'></div>
								...
								<li class='list-group-item'>
									<div class='row my-2'>
										...
										<div class='col'>
											<h3 class='h5'>Continuous Delivery и Continuous Deployment</h3>
											<div class='mt-3 text-muted'>3 недели</div>
										</div>
										<div class='w-100 d-lg-none'></div>
										<div class='col-1 d-lg-none'></div>
										<div class='col col-lg-auto d-flex flex-lg-column flex-wrap flex-lg-nowrap align-items-lg-end justify-content-lg-center mt-2 mt-lg-0'>
								...
								<li class='list-group-item'>
									<div class='row my-2'>
										...
										<div class='col'>
											<h3 class='h5'>Infrastructure as Code и системы управления конфигурацией</h3>
								...
								<li class='list-group-item'>
									<div class='row my-2'>
										...
										<div class='col'>
											<h3 class='h5'>DBOps -реляционные и нереляционные базы данных</h3>
											<div class='mt-3 text-muted'>2 недели</div>
										</div>
										<div class='w-100 d-lg-none'></div>
										<div class='col-1 d-lg-none'></div>
								...
								<li class='list-group-item'>
									<div class='row my-2'>
										...
										<div class='col'>
											<h3 class='h5'>Docker-контейнеризация и хранение данных </a></h3>
											<div class='mt-3 text-muted'>1 неделя</div>
										</div>
										<div class='w-100 d-lg-none'></div>
										<div class='col-1 d-lg-none'></div>
										<div class='col col-lg-auto d-flex flex-lg-column flex-wrap flex-lg-nowrap align-items-lg-end justify-content-lg-center mt-2 mt-lg-0'>
								...
								<li class='list-group-item'>
									<div class='row my-2'>
										...
										<div class='col'>
											<h3 class='h5'>Микросервисы, балансировка и кэширование </h3>
											<div class='mt-3 text-muted'>2 недели</div>
										</div>
										<div class='w-100 d-lg-none'></div>
										<div class='col-1 d-lg-none'></div>
								...
								<li class='list-group-item'>
									<div class='row my-2'>
										...
										<div class='col'>
											<h3 class='h5'>Kubernetes. Деплой и обеспечение надёжности приложения  </h3>
											<div class='mt-3 text-muted'>1 неделя</div>
										</div>
										<div class='w-100 d-lg-none'></div>
										<div class='col-1 d-lg-none'></div>
								...
								<li class='list-group-item'>
									<div class='row my-2'>
										<div class='col-1 text-center'>
											<div class='h3 fw-light'>10</div>
										</div>
										<div class='col'>
											<h3 class='h5'>Авария </h3>
											<div class='mt-3 text-muted'>1 неделя</div>
										</div>
										<div class='w-100 d-lg-none'></div>
										<div class='col-1 d-lg-none'></div>
				...
				<div style="text-align:center;margin-bottom:2%;margin-top:2%;"><a class="back" href='каталог_курсов.php'>В каталог</a><a class="back" href='dev.php'>Начать</a></div>
			</div>	
			<script>
				(function ($){
				  $.fn.counter = function() {
