...
<html>
	<head>
		...
		<title>План курса "Frontend"</title>
...
<!--1 глава-->
<details>
    <summary><b><a href='fr.php' style='color:#000;'>1)Бесплатная вводная часть</a></b></summary>
    <p>
		1 Три составляющих фронтенда<br>
		2 jQuery<br>
		3 MVC<br>
		4 Процессоры и сборщики<br>
		5 CSS<br>
		6 JavaScript<br>
		7 HTML<br>
		8 CSS-фреймворки, адаптивность<br>
		9 Кроссбраузерность<br>
	</p>
</details>

<!--2 глава-->
<details>
    <summary>2)<a data-toggle="modal" data-target="#exampleModal" >Проект «Веб-мессенджер»</a></summary>
    <p>
		1 Первые сайты<br>
	</p>
</details>
<!--3 глава-->
<details>
    <summary><a data-toggle="modal" data-target="#exampleModal" >3)Командный проект</a></summary>
    <p>Команда формируется согласно результатам голосования<br>
	</p>
</details>
<!--4 глава-->
<details>
    <summary><a data-toggle="modal" data-target="#exampleModal" >4)Алгоритмы и структуры данных. Включённый курс</a></summary>
	<p>1 Алгоритмы и структуры данных<br>
	</p>
</details>
<!--5 глава-->
<details>
    <summary><a data-toggle="modal" data-target="#exampleModal" >5)Карьерный трек</a></summary>
	<p>1 По объявлению<br>
	</p>
</details>
